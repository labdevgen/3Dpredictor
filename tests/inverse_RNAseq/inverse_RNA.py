...
# inversion = Interval("chr11", 207600, 209700) # начало инверсии задевают tss гена ENSG00000177963
# inversion = Interval("chr11", 207500, 215200) # ген ENSG00000177963 полностью лежит внутри инверсии
# inversion = Interval("chr11", 207500, 236600) # ген ENSG00000177963 полностью лежит внутри инверсии, инверсия затрагивает tss генов ENSG...142082 и ENSG...185627
# inversion = Interval("chr11", 207500, 253000) # гены ...177963, ...142082 и ...185627 лежат внутри инверсии
inversion = Interval("chr11", 207500, 209600) # начало инверсии перед геном ENSG00000177963 конец инверсии лежит внутри гена, но не задевает tss


rna_reader.inverse_region_RNA(inversion, r"C:\Users\admin\3DPredictor-tests\3Dpredictor\tests\deletion_RNASeq_2\mart_export_txt")
